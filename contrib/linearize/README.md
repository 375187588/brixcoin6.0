# Linearize
Construct a linear, no-fork, best version of the Brixcoin blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install brixcoin_hash

https://github.com/brixcoinpay/brixcoin_hash
...
JSON-RPC server. Running `brixcoind` or `brixcoin-qt -server` will be sufficient.
...
* `input`: brixcoind blocks/ directory containing blkNNNNN.dat
