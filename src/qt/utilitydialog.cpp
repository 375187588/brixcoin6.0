    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  brixcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Brixcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BRIX, 0.1 BRIX, 1 BRIX and 10 BRIX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://www.brixco.in/PrivateSend\">https://www.brixco.in/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
