    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BRIX-light"), QVariant("light"));
    ui->theme->addItem(QString("BRIX-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BRIX-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("BRIX-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("BRIX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BRIX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BRIX-traditional"), QVariant("trad"));
