...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Brixcoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "brixcoin",               "masternode",             &masternode,             true,  {} },
    { "brixcoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "brixcoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "brixcoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "brixcoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "brixcoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
