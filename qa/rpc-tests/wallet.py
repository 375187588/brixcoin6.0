...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 BRIX from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 BRIX in block rewards plus fees, but
        ...
        # Send 100 BRIX with subtract fee from amount
        ...
        # Sendmany 100 BRIX with subtract fee from amount
