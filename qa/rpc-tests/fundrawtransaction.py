...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid brixcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid brixcoin address" in e.error['message'])
