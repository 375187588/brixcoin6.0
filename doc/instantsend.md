...
This mechanism has been integrated into Bitcore-Node-Brixcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/brixcoinpay/insight-api-brixcoin#web-socket-api](https://github.com/brixcoinpay/insight-api-brixcoin#web-socket-api)
* API: [https://github.com/brixcoinpay/insight-api-brixcoin#instantsend-transactions](https://github.com/brixcoinpay/insight-api-brixcoin#instantsend-transactions)
...
By default, the Brixcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Brixcoin Core daemon:
