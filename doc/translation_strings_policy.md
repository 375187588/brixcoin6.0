...
This document provides guidelines for internationalization of the Brixcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `brixcoin_en.ts` remains unchanged.
